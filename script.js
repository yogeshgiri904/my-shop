...
// products + cart script
const fertilizerProducts = [
    { id: "fp-1", name: "IFFCO Urea", price: 266, unit: "45kg bag", image: "partner/par-1.png", description: "Nitrogen fertilizer for rapid vegetative growth." },
    { id: "fp-2", name: "Nano Urea Liquid", price: 240, unit: "500ml bottle", image: "partner/par-10.png", description: "Efficient nitrogen delivery with low wastage." },
    { id: "fp-3", name: "DAP Fertilizer", price: 1350, unit: "50kg bag", image: "partner/par-6.png", description: "Phosphorus rich base fertilizer for roots." },
    { id: "fp-4", name: "NPK 10:26:26", price: 1450, unit: "50kg bag", image: "partner/par-4.png", description: "Balanced nutrient blend for flowering stage." },
    { id: "fp-5", name: "NPK 12:32:16", price: 1520, unit: "50kg bag", image: "partner/par-5.png", description: "Popular starter grade for multiple crops." },
    { id: "fp-6", name: "NPK 20:20:0:13", price: 1180, unit: "50kg bag", image: "partner/par-7.png", description: "Nitrogen-sulphur combo for stronger growth." },
    { id: "fp-7", name: "MOP Potash", price: 980, unit: "50kg bag", image: "partner/par-8.png", description: "Potassium support for crop quality." },
    { id: "fp-8", name: "SOP Potash", price: 1320, unit: "25kg bag", image: "partner/par-9.png", description: "Chloride-free potash for sensitive crops." },
    { id: "fp-9", name: "SSP Fertilizer", price: 420, unit: "50kg bag", image: "partner/par-12.png", description: "Affordable phosphorus and sulphur source." },
    { id: "fp-10", name: "Zinc Sulphate 21%", price: 460, unit: "10kg bag", image: "partner/par-13.png", description: "Corrects zinc deficiency effectively." },
    { id: "fp-11", name: "Ferrous Sulphate", price: 360, unit: "10kg bag", image: "partner/par-14.png", description: "Improves chlorophyll and leaf color." },
    { id: "fp-12", name: "Boron 20%", price: 310, unit: "1kg pack", image: "partner/par-15.png", description: "Boosts flowering and fruit setting." },
    { id: "fp-13", name: "Calcium Nitrate", price: 720, unit: "25kg bag", image: "partner/par-16.png", description: "Calcium + nitrogen for healthy fruits." },
    { id: "fp-14", name: "Magnesium Sulphate", price: 410, unit: "25kg bag", image: "assets/testmonial/1.jpg", description: "Supports photosynthesis and greenness." },
    { id: "fp-15", name: "Humic Acid Granules", price: 520, unit: "25kg bag", image: "assets/testmonial/2.jpg", description: "Improves soil structure and root mass." },
    { id: "fp-16", name: "Seaweed Extract", price: 650, unit: "1L bottle", image: "assets/testmonial/3.jpg", description: "Natural growth promoter for stress recovery." },
    { id: "fp-17", name: "Amino Acid Fertilizer", price: 560, unit: "1L bottle", image: "assets/testmonial/4.jpg", description: "Enhances nutrient uptake and vigor." },
    { id: "fp-18", name: "Neem Cake Powder", price: 390, unit: "25kg bag", image: "assets/testmonial/5.jpg", description: "Organic soil conditioner and mild pest repellent." }
];

const pesticideProducts = [
    { id: "fp-19", name: "Imidacloprid 17.8 SL", price: 780, unit: "500ml bottle", image: "img/2-min.png", description: "Systemic control of sucking pests." },
    { id: "fp-20", name: "Chlorpyrifos 20 EC", price: 640, unit: "1L bottle", image: "img/3-min.png", description: "Broad-spectrum insecticide for fields." },
    { id: "fp-21", name: "Lambda Cyhalothrin 5 EC", price: 460, unit: "250ml bottle", image: "img/1-min.png", description: "Fast knockdown action on major insects." },
    { id: "fp-22", name: "Mancozeb 75 WP", price: 440, unit: "1kg pack", image: "partner/par-3.png", description: "Preventive fungicide for fungal diseases." },
    { id: "fp-23", name: "Carbendazim 50 WP", price: 520, unit: "1kg pack", image: "partner/par-2.png", description: "Curative fungicide for leaf and root issues." },
    { id: "fp-24", name: "Glyphosate 41 SL", price: 680, unit: "1L bottle", image: "test/4.jpg", description: "Non-selective weed management solution." },
    { id: "fp-25", name: "Atrazine 50 WP", price: 360, unit: "1kg pack", image: "test/8.jpg", description: "Pre-emergence herbicide for weed control." }
];

const seedProducts = [
    { id: "sd-1", name: "Wheat Seed HD-2967", price: 210, unit: "10kg bag", image: "seed/wheat-min.png", description: "Popular high-yielding wheat variety." },
    { id: "sd-2", name: "Paddy Seed 1121", price: 290, unit: "10kg bag", image: "seed/rice-min.png", description: "Fine grain paddy with premium quality." },
    { id: "sd-3", name: "Maize Hybrid 900M", price: 420, unit: "4kg pack", image: "seed/corn-min.png", description: "Strong cob filling and high productivity." },
    { id: "sd-4", name: "Bajra Hybrid BH-946", price: 320, unit: "2kg pack", image: "seed/potato-min.png", description: "Drought-tolerant pearl millet hybrid." },
    { id: "sd-5", name: "Mustard Pusa Bold", price: 380, unit: "2kg pack", image: "seed/tomato-min.png", description: "Widely grown mustard seed for oil." },
    { id: "sd-6", name: "Chana Seed JG-11", price: 260, unit: "10kg bag", image: "seed/cabbage-min.png", description: "Reliable gram variety with good market demand." },
    { id: "sd-7", name: "Arhar Seed UPAS-120", price: 300, unit: "5kg bag", image: "seed/carrot-min.png", description: "Early maturing pigeon pea variety." },
    { id: "sd-8", name: "Moong Seed PDM-139", price: 340, unit: "5kg bag", image: "seed/corn-min.png", description: "Short duration moong for multiple seasons." },
    { id: "sd-9", name: "Urad Seed T-9", price: 330, unit: "5kg bag", image: "seed/rice-min.png", description: "Stable black gram performance." },
    { id: "sd-10", name: "Soybean JS-335", price: 290, unit: "10kg bag", image: "seed/wheat-min.png", description: "Trusted soybean for oil and protein." },
    { id: "sd-11", name: "Groundnut GG-20", price: 410, unit: "8kg bag", image: "seed/potato-min.png", description: "Improved pod filling and kernel quality." },
    { id: "sd-12", name: "Sesame Seed RT-46", price: 430, unit: "2kg pack", image: "seed/tomato-min.png", description: "High oil content sesame variety." },
    { id: "sd-13", name: "Cotton Hybrid BT-2", price: 860, unit: "450g pack", image: "seed/cabbage-min.png", description: "Widely used cotton hybrid seed." },
    { id: "sd-14", name: "Sunflower Hybrid SFH-1", price: 520, unit: "2kg pack", image: "seed/carrot-min.png", description: "Bold seeds with good oil recovery." },
    { id: "sd-15", name: "Tomato Hybrid 505", price: 640, unit: "50g pack", image: "seed/tomato-min.png", description: "Uniform fruiting with high market value." },
    { id: "sd-16", name: "Chilli Hybrid Tejaswini", price: 620, unit: "50g pack", image: "seed/corn-min.png", description: "High pungency chilli hybrid." },
    { id: "sd-17", name: "Brinjal Hybrid BH-2", price: 560, unit: "50g pack", image: "seed/potato-min.png", description: "Consistent size and glossy fruits." },
    { id: "sd-18", name: "Okra Hybrid OH-102", price: 540, unit: "500g pack", image: "seed/cabbage-min.png", description: "High picking frequency and yield." },
    { id: "sd-19", name: "Cucumber Hybrid CH-1", price: 590, unit: "50g pack", image: "seed/carrot-min.png", description: "Uniform shape and attractive color." },
    { id: "sd-20", name: "Bottle Gourd Hybrid BG-8", price: 500, unit: "100g pack", image: "seed/tomato-min.png", description: "Long, uniform fruits with high demand." },
    { id: "sd-21", name: "Watermelon Hybrid WH-3", price: 680, unit: "100g pack", image: "seed/corn-min.png", description: "Sweet flesh and strong transportability." },
    { id: "sd-22", name: "Muskmelon Hybrid MH-7", price: 650, unit: "100g pack", image: "seed/wheat-min.png", description: "Aromatic fruits with better shelf life." },
    { id: "sd-23", name: "Cabbage Hybrid Green Crown", price: 610, unit: "50g pack", image: "seed/cabbage-min.png", description: "Compact heads and good field stand." },
    { id: "sd-24", name: "Cauliflower Hybrid Snow Ball", price: 620, unit: "50g pack", image: "seed/carrot-min.png", description: "High curd quality and whiteness." },
    { id: "sd-25", name: "Onion Seed Agrifound", price: 570, unit: "500g pack", image: "seed/rice-min.png", description: "Good storability and bulb uniformity." }
];
